...
import { Sparkles, ChevronDown, ChevronUp, Code, Users, Briefcase, MessageSquare, Lock } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              {!user && (
                <p className="text-center text-xs text-muted-foreground mt-2">
                  <span className="text-violet-400">Login required</span> to generate interview questions
                </p>
              )}
            </div>
          </div>
